<html>
	<head>
		<title>
			Bus Information | SmartBusBooking.com
		</title>
...
#customers th {
	...
	<body>
       ...
       <div class="topnav">
			...
			<a class="active" href="bus.php">Bus Information</a>
				...
				<tr>
					<td>
						<fieldset>
							...
							<legend align="center"><h1 style="color:#Blue;" ><b>Bus Information</b></h1></legend> 
							<table width="1100" height="300">
							   <input type="text" onkeyup="getData(this.value)" placeholder="Search" />
			
			<br/>
			
			<div align="center"> <p id="sug">Suggestion:</p></div>
	...
	<?php include 'user_bus_details.php'; showdata(); ?>
		  <script >
